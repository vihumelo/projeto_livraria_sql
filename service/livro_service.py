...
class LivroService:
    ...
    @property
    def livro_dao(self) -> LivroDAO:
        return self.__livro_dao
    ...
    def listar(self):
        ...
        try:
            ...
            for livro in livros:
                ...
                print(f'{livro.id} | {livro.titulo} | {livro.resumo} | {livro.ano} | {livro.paginas} | {livro.isbn} | {livro.categoria.nome} | {livro.editora.nome} | {livro.autor.nome}')
    ...
    def mostrar_por_id(self):
            ...
            try:
                ...
                aut = self.__livro_dao.buscar_por_id(id)


                if (aut == None):
                    print('Livro não encontrado!')
                else:
                    print(f'Id: {aut.id} | livro: {aut.nome}')    
            except Exception as e:
